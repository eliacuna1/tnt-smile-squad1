  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none select-none">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(255,0,127,0.1)_0%,transparent_70%)] opacity-50"></div>
      </div>
        ...
        <div className="liquid-glass-wrapper overflow-visible">
          <h1 className="flex flex-col items-center text-[12vw] md:text-[6.5rem] lg:text-[8.5rem] font-good-castyll leading-[0.65] tracking-tight mb-8">
            <span className="block px-20 -mx-20">
              <span className="hero-line block px-10 liquid-glass-text">EMERGENCY</span>
            </span>
            <span className="block px-20 -mx-20">
              <span className="hero-line block px-10 liquid-glass-text liquid-glass-pink">CONVERSION</span>
            </span>
          </h1>
        </div>
      ...
      <div className="hero-fade absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center pointer-events-none z-20">
        <div className="relative flex flex-col items-center animate-magical-float">
          <div className="absolute inset-0 w-32 h-32 bg-gradient-to-tr from-plasma-pink via-plasma-purple to-plasma-blue opacity-20 blur-3xl rounded-full -translate-y-1/2 -translate-x-1/2 left-1/2 top-1/2 animate-pulse"></div>
