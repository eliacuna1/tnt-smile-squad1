            ...
            {camp.scribbles.map((sc, i) => (
              ...
              >
                <span className={`font-['Caveat'] text-white whitespace-nowrap
                  ...
                  ${sc.style === 'italic-dim' ? 'italic opacity-30 text-base' : ''}
                  text-lg lg:text-2xl
                `}>
                  {sc.text}
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-8 md:p-12 z-10 pointer-events-none">
                 <div className="transform transition-all duration-1000 group-hover:-translate-y-4">
                    ...
                    <div className="flex items-center gap-3 mt-6 opacity-0 group-hover:opacity-100 transition-all duration-1000 translate-y-4 group-hover:translate-y-0 text-white/40 group-hover:text-white">
